...
```
e120 flash-firmware third-party/firmware/E320_PWM_FPGA16.53_20231227_SM16386S_SM16269SH.hex \
     --backup <snapshot>/primary-region.bin --commit
```

Take `e120 snapshot` first; it captures the primary region and the golden bank,
