...
* **LED side:** roughly **147 pins**, driving up to twelve HUB75E connectors
  ...
  CLK, LAT, OE) are the top-edge pads, identified as a group but **not
  individually**.
...
* **Utilisation:** ~95 %. 20 170 functional LUT4s of 24 288; 13 074 flip-flops;
  the whole DSP row; nearly all the block RAM. **The part is full.**
...
One limit to know before planning work: **deep backward tracing is only
...
serial RGB data". That is both the most likely explanation for the panel
