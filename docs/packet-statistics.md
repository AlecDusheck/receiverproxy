...
Run `e120 raw-send --type 0900 --pad 270 --payload 00ffff` (§4) first so both
...
use `raw-send` when you want the raw reply bytes):

```sh
e120 raw-send --type 0700 --pad 270 --payload 000000 --show 128
```
...
```sh
e120 raw-send --type 0900 --pad 270 --payload 00ffff --wait 0
```
