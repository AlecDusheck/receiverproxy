...
| **LUT utilisation** | **~95 %** | the device is nearly full |
...
Either way the design uses **nearly all** the block RAM
...
**Feedback:** `arc CLKFB ← JCLKFB3` and `CIB_PLL3: arc JCLK0 ← G_HPBX0200`, so
...
`BDCC0` stands out: a fabric-generated signal re-buffered onto the global
